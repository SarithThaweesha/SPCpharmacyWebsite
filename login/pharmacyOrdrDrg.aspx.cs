...
namespace login
{
    public partial class pharmacyOrdrDrg : System.Web.UI.Page
    {
        ...
        {
            string value = obj.placeOrderPh(txtOrder.Text,txtPha.Text, txtCon.Text, txtDrugName.Text, txtQty.Text, txtDate.Text);
