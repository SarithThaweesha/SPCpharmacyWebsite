<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="registerPharmacies.aspx.cs" Inherits="login.registerPharmacies" %>
                ...
                <div class="card">
                    ...
                    <div class="col">
                            ...
                            <div class="form-group">
                                <asp:TextBox  CssClass="form-control" ID="txtPhId" runat="server" placeholder="pharmacyID"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RFVPhId" runat="server" ErrorMessage="Pharmacy Id can't be blank" ControlToValidate="txtPhId" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                    ...
                    <div class="col">
                            ...
                            <div class="form-group">
                                <asp:TextBox  CssClass="form-control" ID="txtPhName" runat="server" placeholder="PharmacyName"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RFVPhName" runat="server" ErrorMessage="Pharmacy Name can't be blank" ControlToValidate="txtPhName" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
